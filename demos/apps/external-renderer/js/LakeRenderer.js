define([
  ...
  var LakeRenderer = declare([], {
    ...
    _setupScene: function() {
      ...
      // this.water.translateX(this.geometry.origin[0]);
      // this.water.translateY(this.geometry.origin[1]);
      // this.water.translateZ(this.geometry.origin[2]);
